...
const Header = () => {
  ...
  return (
    <div className="w-full h-auto pt-2 pb-2 lg:pt-5 lg:pb-5 grid grid-cols-10 items-center shadow-[0_3px_0px_rgb(1_1_1)]">
      <h2 className="text-xl md:text-3xl lg:text-5xl col-start-2 col-span-4 lg:col-start-2 lg:col-span-5 text-shadow-[-4px_4px_0_var(--main)] ">Detect Text Emotion</h2>
